...
1. `spot-the-difference-race`、`mini-gomoku`、`seat-map-strategy`、`signal-scramble`、`baggage-sort-showdown`、`cabin-card-clash` 和 `airline-trivia-teams` 已经落地，下一步优先转向下一个 Wave B 游戏 `tap-beat-battle`。
