...
- 当前代码基线里已经有二十五款验证游戏：
  - `crew-coordination`：2-4 人协作排班 relay，已接入房间、WS、共享 team score 和独立 package 页面。
...
| `crew-coordination` | Crew Coordination | 多人协作解谜 | 2-4 人 turn-based | L | P3 | Wave C | 已实现 | 放在最后验证多人协作体验 |
